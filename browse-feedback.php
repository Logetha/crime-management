...
<li>Filing a false police report is a crime.</li>
					...
					<div class ="col-5" >
				<div class="card-header"><i class=""></i> <strong>Contact TPD Phone Numbers</strong> </div>
				<br>
   	...
   	<div class="container">
		...
		<hr>
		<div class="card-header"><i class=""></i> <strong>Feedback</strong> <a href="add-feedback.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Feedback</a></div>
	</br>
		<div>
			<table class="table table-striped table-bordered">
				<thead>
