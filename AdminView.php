			...
			<tbody>
				<?php foreach($select as $select_data){ ?>
					<tr>
						...
						<td align="center">
							<a href="update.php?id=<?php echo $select_data['Id']; ?>" class="text-primary"><i class="fa fa-fw fa-edit"></i>Update</a>
							<a href="view.php?id=<?php echo $select_data['Id']; ?>" class="text-danger"onClick="return confirm('Are you sure to delete this user?');"><i class="fa fa-fw fa-trash"></i>Delete</a>
						</td>
					</tr>
						<?php } ?>
			</tbody>
